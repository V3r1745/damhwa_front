      ...
      <div className="today-pro-wrap">
        <div className="each-pro-box">
          ...
          <div className="each-pro-price-box">
            <p className="each-pro-price">{data.at(0)?.fields.product_price}</p>
        ...
        <div className="each-pro-box">
          ...
          <div className="each-pro-price-box">
            <p className="each-pro-price">{data.at(1)?.fields.product_price}</p>
            <p className="each-pro-krw">원</p>
          </div>
        </div>
        <div className="each-pro-box">
          ...
          <div className="each-pro-price-box">
            <p className="each-pro-price">{data.at(2)?.fields.product_price}</p>
            <p className="each-pro-krw">원</p>
          </div>
        </div>
        <div className="each-pro-box">
          ...
          <div className="each-pro-price-box">
            <p className="each-pro-price">{data.at(3)?.fields.product_price}</p>
            <p className="each-pro-krw">원</p>
          </div>
        </div>
      </div>
